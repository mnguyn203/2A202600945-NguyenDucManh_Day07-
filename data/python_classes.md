...
[`__doc__`](../reference/datamodel.html#type.__doc__ "type.__doc__") is also a valid attribute, returning the docstring
...
`__next__()` raises a [`StopIteration`](../library/exceptions.html#StopIteration "StopIteration") exception which tells the
...
[`__dict__`](../reference/datamodel.html#object.__dict__ "object.__dict__") which returns the dictionary used to implement the module’s
