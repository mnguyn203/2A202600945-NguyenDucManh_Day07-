---
{
  ...
  "doc_title": "Input and Output",
  "detected_title": "7. Input and Output",
  "topic": "io",
  "difficulty": "beginner",
...
The [`string`](../library/string.html#module-string "string: Common string operations.") module contains support for a simple templating approach
based upon regular expressions, via [`string.Template`](../library/string.html#string.Template "string.Template").
