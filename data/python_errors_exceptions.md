---
{
  ...
  "doc_title": "Errors and Exceptions",
  "detected_title": "8. Errors and Exceptions",
  "topic": "errors",
...
- If the `finally` clause executes a [`break`](../reference/simple_stmts.html#break),
  ...
  version 3.14 the compiler emits a [`SyntaxWarning`](../library/exceptions.html#SyntaxWarning "SyntaxWarning") for it
